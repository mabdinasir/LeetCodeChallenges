...
print(np.floor(arr)) #floor returns the floor of the input element-wise.
print(np.ceil(arr)) #ceil returns the ceiling of the input element-wise.
print(np.rint(arr)) #rint rounds to the nearest integer of input element-wise.